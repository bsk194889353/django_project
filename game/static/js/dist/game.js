...
class MultiPlayerSocket {
    constructor(playground){
        ...
        this.ws = new WebSocket("wss://app6641.acapp.acwing.com.cn/wss/multiplayer/");
...
`);
    ...
    login_on_remote() {
        ...
        $.ajax({
            url: "https://app6641.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
